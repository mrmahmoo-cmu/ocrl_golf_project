...
Includes crosswind and landed-terrain penalties.
...
BOUNDS_LOWER = [5.0,  np.radians(5),  np.radians(-5)]
BOUNDS_UPPER = [30.0, np.radians(60), np.radians(30)]
N_VARS = 3
...
def main():
    ...
    x0 = np.array([20.0, np.radians(25), AIM_ANGLE_TO_HOLE])
