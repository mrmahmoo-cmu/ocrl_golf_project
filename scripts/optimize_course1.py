...
# Aim range narrower since hole is straight ahead
BOUNDS_LOWER = [np.radians(-15), np.pi/4] + [-150.0, -60.0] * N_BINS
BOUNDS_UPPER = [np.radians(15), np.pi] + [150.0, 60.0] * N_BINS
N_VARS = 2 + N_BINS * 2
...
def main():
    print("=" * 60)
    print("COURSE 1: Straight Shot — CMA-ES Optimization")
    print("=" * 60)
    ...
    x0 = np.zeros(N_VARS)
    x0[0] = AIM_ANGLE_TO_HOLE  # 0 deg — straight ahead
    x0[1] = 3 * np.pi / 4
